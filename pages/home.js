...
<body>
  ...
  <section class="section" id="how">
    <div class="container">
      <p class="section-label" style="font-size:22px;">How It Works</p>
    ...
    <div class="container">
      ...
      <div class="roi-wrap">
        <div class="card" style="margin-bottom:28px;">
          <div class="section-label" style="text-align:left;margin-bottom:20px;font-size:16.5px;font-weight:700;">Your Sending Profile</div>
        ...
        <div class="roi-grid">
          <div class="roi-card roi-poor">
            <div style="font-family:var(--mono);font-size:15px;font-weight:700;letter-spacing:3px;color:var(--danger);margin-bottom:16px;">POOR DELIVERABILITY</div>
          ...
          <div class="roi-card roi-great">
            <div style="font-family:var(--mono);font-size:15px;font-weight:700;letter-spacing:3px;color:var(--green-dark);margin-bottom:16px;">GREAT DELIVERABILITY</div>
            <div style="font-family:var(--display);font-size:12px;font-weight:600;color:var(--muted);margin-bottom:4px;">OPEN RATE</div>
        ...
        <div class="roi-lift">
          <div>
            <div style="font-family:var(--mono);font-size:16.5px;font-weight:700;letter-spacing:2px;color:var(--muted);margin-bottom:8px;">REVENUE UNLOCKED BY INBOXSMARTS / YEAR</div>
